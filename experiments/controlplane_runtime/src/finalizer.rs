...
use controlplane_client::Resource;
use controlplane_client::ResourceExt;
    ...
    ReconcileErr: StdError + 'static,
{
    ...
    AddFinalizer(#[source] controlplane_client::Error),
    
    #[error("failed to remove finalizer: {0}")]
    RemoveFinalizer(#[source] controlplane_client::Error),
