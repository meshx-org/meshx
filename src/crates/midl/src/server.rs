...
use {
    crate::{
        encoding::{DynamicFlags, Encode, TransactionHeader, TransactionMessage, TransactionMessageType, TypeMarker},
        epitaph,
...
impl ServeInner {
    ...
    pub fn shutdown_with_epitaph(&self, status: fx_status::Status) {
