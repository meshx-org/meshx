...
use tower_http::{classify::ServerErrorsFailureClass, map_response_body::MapResponseBodyLayer, trace::TraceLayer};
use tracing::Span;

use super::{config_ext::ConfigExt, Body};
use crate::{config::Config, Client, Error};
    ...
    H::Error: 'static + Send + Sync + std::error::Error,
{
    ...
    let service = ServiceBuilder::new()
        ...
        .map_err(|e: hyper_util::client::legacy::Error| e.into())
        .service(client);
