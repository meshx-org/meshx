use controlplane_api::{apimachinery::apis::meta::v1::OwnerReference, core::v1::ObjectReference};
use controlplane_client::{core::{api_version_from_group_version, discovery::ApiResource, dynamic::DynamicObject}, Resource};
...
impl<K: Lookup> From<ObjectRef<K>> for ObjectReference {
    fn from(val: ObjectRef<K>) -> Self {
        let ObjectRef {
            ...
            name,
            namespace,
            extra: Extra { resource_version, uid },
        } = val;
        ObjectReference {
...
mod tests {
    ...
    fn display_should_follow_expected_format() {
        ...
        assert_eq!(
            format!("{}", ObjectRef::<Deployment>::new("my-deploy").within("my-namespace")),
