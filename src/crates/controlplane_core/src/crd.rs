use controlplane_api::apiextensions as apiexts;

/// Types for v1 CustomResourceDefinitions
pub mod v1 {
    use super::apiexts::v1::crd::CustomResourceDefinition as Crd;
    ...
    /// use controlplane_core::crd::merge_crds;
    ...
    mod tests {
        ...
        fn crd_merge() {
            ...
            let c1: Crd = serde_yml::from_str(crd1).unwrap();
            let c2: Crd = serde_yml::from_str(crd2).unwrap();
            let ce: Crd = serde_yml::from_str(expected).unwrap();
