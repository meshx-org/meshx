...
impl GenericDispatcher {
    pub fn as_job_dispatcher(&self) -> Option<Arc<JobDispatcher>> {
        match self {
    ...
    pub fn as_process_dispatcher(&self) -> Option<Arc<ProcessDispatcher>> {
        match self {
    ...
    pub fn as_channel_dispatcher(&self) -> Option<Arc<ChannelDispatcher>> {
        match self {
