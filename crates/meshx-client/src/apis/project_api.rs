...
pub async fn create_project(configuration: &configuration::Configuration, ) -> Result<(), Error<CreateProjectError>> {
...
pub async fn list_projects(configuration: &configuration::Configuration, ) -> Result<(), Error<ListProjectsError>> {
