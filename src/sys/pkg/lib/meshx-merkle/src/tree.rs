...
mod tests {
    ...
    fn test_from_reader_empty() {
        ...
        let tree = MerkleTree::from_reader(&data_to_hash[..]).unwrap();
        let expected: Hash = "15ec7bf0b50732b49f8228e07d24365338f9e3ab994b00af08e5a3bffe55fd8b"
            .parse()
            .unwrap();
    ...
    fn test_from_reader_oneblock() {
        let data_to_hash = [0xffu8; 8192];
        let tree = MerkleTree::from_reader(&data_to_hash[..]).unwrap();
        let expected: Hash = "68d131bc271f9c192d4f6dcd8fe61bef90004856da19d0f2f514a7f4098b0737"
            .parse()
            .unwrap();
        assert_eq!(tree.root(), expected);
    }
    ...
    fn test_from_reader_unaligned() {
        ...
        let expected: Hash = "7577266aa98ce587922fdc668c186e27f3c742fb1b732737153b70ae46973e43"
            .parse()
            .unwrap();
        assert_eq!(tree.root(), expected);
    }
