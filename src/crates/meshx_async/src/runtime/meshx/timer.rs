...
use crate::runtime::{Time, WakeupTime};
use super::executor::EHandle;
...
impl Interval {
    ...
    pub fn new(duration: fx::Duration) -> Self {
...
mod test {
    ...
    use fiber_rust::prelude::*;
    use fiber_rust::Duration;
