...
pub enum ConfigCommand {
    /// Initialize a new configuration file for meshx
    Init {
        #[clap(long)]
    ...
    /// Print the current version and local directories used by meshx
    Info {},
    /// Print the current configuration file for meshx
    Show {},
