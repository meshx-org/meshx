...
pub async fn create_organization(configuration: &configuration::Configuration, ) -> Result<(), Error<CreateOrganizationError>> {
...
pub async fn get_organization_by_id(configuration: &configuration::Configuration, id: f64) -> Result<(), Error<GetOrganizationByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/organizations/{id}", configuration.base_path, id=p_path_id);
...
pub async fn list_organizations(configuration: &configuration::Configuration, ) -> Result<(), Error<ListOrganizationsError>> {
