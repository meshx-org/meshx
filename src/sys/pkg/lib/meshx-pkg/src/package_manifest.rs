...
use {
    ...
    camino::Utf8Path,
    meshx_archive::{self, Utf8Reader},
    meshx_hash::Hash,
    meshx_merkle::from_slice,
    meshx_url::{RepositoryUrl, UnpinnedAbsolutePackageUrl},
...
impl PackageManifest {
    ...
    pub async fn archive(
        ...
        meshx_archive::write(out, contents)?;
        Ok(())
    }
    ...
    pub fn from_blobs_dir(
        ...
        let mut meta_far = meshx_archive::Utf8Reader::new(&mut meta_far_file)?;
        ...
        let meta_subpackages = match meta_far.read_file(MetaSubpackages::PATH) {
            ...
            Err(meshx_archive::Error::PathNotPresent(_)) => BTreeMap::new(),
...
mod tests {
    ...
    fn test_from_blobs_dir() {
        ...
        let write_blob = |contents| {
            let mut builder = meshx_merkle::MerkleTreeBuilder::new();
        ...
        let mut merkle_builder = meshx_merkle::MerkleTreeBuilder::new();
