...
//! A "prelude" of common MIDL traits, to be used like `use midl::prelude::*;`.
...
pub use crate::endpoints::{
    ControlHandle as _, DiscoverableProtocolMarker as _, MemberOpener as _, ProtocolMarker as _, Proxy as _,
    RequestStream as _, Responder as _, ServiceMarker as _, ServiceProxy as _, ServiceRequest as _,
};
