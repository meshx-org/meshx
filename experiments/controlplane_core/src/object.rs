...
use controlplane_api::apimachinery::apis::meta::v1::{ListMeta, ObjectMeta};
use serde::{Deserialize, Deserializer, Serialize};

pub use controlplane_api::{ClusterResourceScope, NamespaceResourceScope, ResourceScope};

use crate::{discovery::ApiResource, metadata::TypeMeta, resource::Resource};
...
impl<T: Clone> ObjectList<T> {
    ...
    ///
    /// ```no_run
    /// use controlplane_core::{ListMeta, ObjectList, TypeMeta};
    /// use k8s_openapi::api::core::v1::Pod;
    ///
    /// let types: TypeMeta = TypeMeta::list::<Pod>();
    /// let metadata: ListMeta = Default::default();
