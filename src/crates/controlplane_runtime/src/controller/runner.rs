use super::future_hashmap::FutureHashMap;
    ...
    MkF: FnMut(&T) -> F,
{
    ...
    pub fn delay_tasks_until<Ready, ReadyErr>(self, ready_to_execute_after: Ready) -> Runner<T, R, F, MkF, Ready>
    where
    ...
    Ready: Future<Output = Result<(), ReadyErr>>,
{
    ...
    fn poll_next(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Option<Self::Item>> {
        ...
        loop {
            ...
            if (*this.max_concurrent_executions > 0 && slots.len() >= *this.max_concurrent_executions as usize)
