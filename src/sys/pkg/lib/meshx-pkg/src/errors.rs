...
use {
    meshx_merkle::Hash,
    meshx_url::errors::{PackagePathSegmentError, ResourcePathError},
    std::{io, path::PathBuf},
...
pub enum PackageManifestError {
    ...
    #[error("archive: {}", _0)]
    Archive(#[from] meshx_archive::Error),
...
pub enum MetaContentsError {
    ...
    #[error("invalid hash")]
    ParseHash(#[from] meshx_hash::ParseHashError),
...
pub enum BuildError {
    ...
    #[error("archive write")]
    ArchiveWrite(#[from] meshx_archive::Error),
}
