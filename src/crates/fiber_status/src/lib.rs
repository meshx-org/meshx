...
use fiber_types as sys;
use std::error;
use std::ffi::NulError;
use std::fmt;
use std::io;

pub use sys::fx_status_t;
...
/// Status type indicating the result of a Fiber syscall.
///
...
assoc_values!(Status, [
    ...
    IO                     = sys::FX_ERR_IO;
    IO_REFUSED             = sys::FX_ERR_IO_REFUSED;
    IO_DATA_INTEGRITY      = sys::FX_ERR_IO_DATA_INTEGRITY;
    IO_DATA_LOSS           = sys::FX_ERR_IO_DATA_LOSS;
    IO_NOT_PRESENT         = sys::FX_ERR_IO_NOT_PRESENT;
    IO_OVERRUN             = sys::FX_ERR_IO_OVERRUN;
    IO_MISSED_DEADLINE     = sys::FX_ERR_IO_MISSED_DEADLINE;
    IO_INVALID             = sys::FX_ERR_IO_INVALID;
    ...
    NOT_CONNECTED          = sys::FX_ERR_NOT_CONNECTED;
    // CONNECTION_REFUSED     = sys::FX_ERR_CONNECTION_REFUSED;
    // CONNECTION_RESET       = sys::FX_ERR_CONNECTION_RESET;
    // CONNECTION_ABORTED     = sys::FX_ERR_CONNECTION_ABORTED;
]);
...
impl From<Status> for io::ErrorKind {
    fn from(status: Status) -> io::ErrorKind {
        ...
        match status {
            ...
            Status::BAD_PATH | Status::INVALID_ARGS | Status::OUT_OF_RANGE | Status::WRONG_TYPE => InvalidInput,
